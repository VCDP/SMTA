...
BaseElement::BaseElement()
{
    ...
    element_type_ = ELEMENT_UNKNOWN;
    element_mode_ = ELEMENT_MODE_UNKNOWN;
    thread_id_ = 0;
#if defined(PLATFORM_OS_WINDOWS)
...
void BaseElement::SetThreadName(const char* name)
{
    FRMW_TRACE_INFO("Not impletement %s\n", __func__);
}
...
{
#if defined(PLATFORM_OS_WINDOWS)
    WaitForSingleObject(src_pad_mutex_, INFINITE);
#else
